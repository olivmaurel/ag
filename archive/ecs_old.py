...
ecs_old.py provides a convenient library to utilize for the ECS pattern.
'''
import json
...
class Entity(object):
    ...
    def __getitem__(self, key):
        '''Allows access to entity fixtures and their properties.
        '''
        return self.components[key]

    def __setitem__(self, key, value):
        '''Allows modification to fixtures.
        '''
...
class System(object):
    '''Identifies a set of fixtures that need to be grouped for tasks
    Systems have a loose coupling with Components and Entities through
    the ComponentFactory Catalog.
    # Initialize entities and their fixtures
    ...
    >>> sorted(MovementSystem.fixtures)
    ...
    def update(self, dt=None):
        '''Runs an update on the various fixtures'''
