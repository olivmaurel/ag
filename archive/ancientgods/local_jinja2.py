...
from ancientgods.settings import JINJA2_DIR
...
def environment(**options):
    env = jinja2.Environment(extensions=[CompressorExtension], **options)
    env.globals.update({
...
def environment_with_loader():
    ...
    return environment(loader=jinja2.FileSystemLoader(JINJA2_DIR), trim_blocks=True)
